...
///******************************函数声明****************************/
static void WriteData(Uint16 addr,Uint16 data);
//static Uint16 ReadData(Uint16 addr);
...
static void WriteData(Uint16 addr,Uint16 data)     //向EEPROM 指定地址写入一个字节的数据
{
    begintrans();                           //开始
    bytein(0x78 + ((addr & 0x0300) >> 7));  //写入写控制字0xA0
    bytein(addr);                           //写入指定地址
...
//Uint16 ReadData(Uint16 addr)                //从EEPROM 指定地址读取一个字节的数据
//{
//    Uint16 c;                               //变量定义
//    begintrans();                           //开始
...
void WriteCmd(Uint16 IIC_Command)  //写命令
{
    WriteData(0x00,IIC_Command);
}

void WriteDat(Uint16 IIC_Data)  //写数据
{
    WriteData(0x40,IIC_Data);
}
